# Generated by Django 4.1.2 on 2023-01-16 06:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movement_code', models.CharField(blank=True, max_length=250, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('upload_id', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='generate_report.uploadfile')),
                ('user', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='incident_generals', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False)),
                ('deleted_at', models.DateTimeField(blank=True, default=None, null=True)),
                ('action_taken', models.TextField(blank=True, max_length=250, null=True)),
                ('incident_location', models.BooleanField(blank=True, default=False, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            name='IncidentGeneral_Picture',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_deleted', models.BooleanField(default=False)),
                ('deleted_at', models.DateTimeField(blank=True, default=None, null=True)),
                ('User_pic', models.FileField(upload_to=incidentreport.models.incident_image_upload_path_pic)),
                ('incident_general', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='incidentreport.incidentgeneral')),
            ],
            options={
                'abstract': False,
